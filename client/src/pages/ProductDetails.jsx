    ...
    return product && (
        <div className="mt-12">
            <p>
                ...
                <Link to={`/productss/${product.category.toLowerCase()}`}> {product.category}</Link> /
           ...
           <div className="flex flex-col items-center mt-20">
              ...
              <div className="g   rid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full">
