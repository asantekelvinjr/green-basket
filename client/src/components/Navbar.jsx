...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 
    border-b border-gray-200 bg-[#F6FFFB]/80 backdrop-blur-md transition-all h-22">
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex flex-col gap-2 px-5 text-sm md:hidden z-50">
          ...
          {!user ? (
            <button
              ...
              className="px-6 py-2 mt-2 bg-primary hover:bg-primary-dull text-white rounded-full"
            >
              Login
            </button>
          ) : (
